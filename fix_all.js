...
const correctHeader = `    <header class="site-header" data-header>
      <div class="section-shell nav-shell">
        <a class="brand" href="/" aria-label="Twoday Studio home">
        ...
        <nav class="site-nav" id="primary-navigation" aria-label="Primary navigation">
          ...
          <a href="play" style="color: var(--mint);" data-i18n="nav_play">Play</a>
          ...
          <a href="press" data-i18n="nav_press">Press</a>
...
for (const file of files) {
    ...
    let newContent = content.replace(/<header class="site-header"[\s\S]*?<\/header>/i, correctHeader);
